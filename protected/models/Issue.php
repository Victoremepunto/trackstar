...
class Issue extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			...
			array('type_id','in','range' => array_keys($this->TypeOptions)),
			array('status_id','in','range' => array_keys($this->StatusOptions)),
		);
	}
	...
	public function getOwnerText() {
	    ...
	    CHtml::encode($this->owner->username) : "unknown user id";
	}
	public function getRequesterText() {
          return isset($this->requester) ?
	    CHtml::encode($this->requester->username) : "unknown user id";
	}
