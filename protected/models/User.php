 ...
 * @property Issue[] $issues_owned
 * @property Issue[] $issues_requested
 */
...
//			array('last_login_time, create_time, update_time', 'safe'),
	...
	public function relations()
	{
		...
		return array(
			...
			'issues_owned' => array(self::HAS_MANY, 'Issue', 'owner_id'),
			'issues_requested' => array(self::HAS_MANY, 'Issue', 'requester_id'),
		);
	}
